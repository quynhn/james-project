...
public class CassandraMessageIdDAO {
    ...
    public CompletableFuture<Stream<ComposedMessageIdWithFlags>> retrieveMessages(CassandraId mailboxId, MessageRange set) {
        switch (set.getType()) {
        case ALL:
    ...
    private CompletableFuture<Stream<ComposedMessageIdWithFlags>> toMessageIds(CompletableFuture<ResultSet> completableFuture) {
