...
public class NetMatcherTest {
    ...
    private static final InetNetworkUtil inetNetworkV4Builder = new InetNetworkUtil(DNS_SERVER_MOCK);
    private static final InetNetworkUtil inetNetworkV6Builder = new InetNetworkUtil(DNS_SERVER_MOCK);

    private NetMatcher netMatcher;

    @Test
    public void matchInetNetworkShouldNotMatchWhenUnknownHostException() throws Exception {
        netMatcher = NetMatcherFactory.getNetMatcher(LOCALHOST_IP_V4_ADDRESSES, DNS_SERVER_MOCK);

        assertThat(netMatcher.matchInetNetwork(HOST_CANNOT_LOOKUP_BY_NAME)).isFalse();
    }

    @Test
    public void matchInetNetworkShouldMatchAllIpV4WhenThoseAreInRange() throws UnknownHostException {
        netMatcher = NetMatcherFactory.getNetMatcher(LOCALHOST_IP_V4_ADDRESSES, DNS_SERVER_MOCK);
    ...
    @Test
    public void matchInetNetworkShouldMatchAllIpV6WhenThoseAreInRange() throws UnknownHostException {
        netMatcher = NetMatcherFactory.getNetMatcher(LOCALHOST_IP_V6_ADDRESSES, DNS_SERVER_MOCK);
    ...
    public void getNetworksShouldNotContainInetNetworkWhenUnknownHostException() {
        netMatcher = NetMatcherFactory.getNetMatcher(ImmutableList.<String>of(HOST_CANNOT_LOOKUP_BY_NAME), DNS_SERVER_MOCK);
    ...
    public void getNetworksShouldRemoveDuplicateWhenIp4() throws Exception {
        netMatcher = NetMatcherFactory.getNetMatcher(LOCALHOST_IP_V4_ADDRESSES_DUPLICATE, DNS_SERVER_MOCK);
    ...
    public void getNetworksShouldRemoveDuplicateWhenIp6() throws Exception {
        netMatcher = NetMatcherFactory.getNetMatcher(LOCALHOST_IP_V6_ADDRESSES_DUPLICATE, DNS_SERVER_MOCK);
