...
public class SpamAssassinTest {
        ...
        MailetContainer mailets = MailetContainer
            ...
            .addProcessor(
                ProcessorConfiguration.builder()
                    ...
                    .build())
            .build();
        jamesServer = TemporaryJamesServer.builder().build(temporaryFolder, mailets);
    ...
    public void test() throws Exception {
        ...
        try (SMTPMessageSender messageSender = SMTPMessageSender.noAuthentication(LOCALHOST_IP, SMTP_PORT, JAMES_ORG);
            ...
            String processedMessage = imapMessageReader.readFirstMessageHeadersInInbox(TO, PASSWORD);

            assertThat(processedMessage).contains(SpamAssassinInvoker.FLAG_MAIL_ATTRIBUTE_NAME);
        }
