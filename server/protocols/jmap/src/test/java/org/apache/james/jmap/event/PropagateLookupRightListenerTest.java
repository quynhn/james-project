...
public class PropagateLookupRightListenerTest {
    ...
    public void setup() throws Exception {
        ...
        testee = new PropagateLookupRightListener(storeRightManager, mailboxMapper);
    ...
    public void getExecutionModeShouldReturnAsynchronous() throws Exception {
        assertThat(testee.getExecutionMode()).isEqualTo(MailboxListener.ExecutionMode.ASYNCHRONOUS);
    }
