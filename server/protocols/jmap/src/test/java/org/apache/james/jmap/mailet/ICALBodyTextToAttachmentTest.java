...
public class ICALBodyTextToAttachmentTest {
    @Rule
    public ExpectedException expectedException = ExpectedException.none();

    private ICALBodyTextToAttachment mailet = new ICALBodyTextToAttachment();

    @Before
    public void setUp() throws Exception {
        mailet.init(FakeMailetConfig.builder()
            .mailetName("ICALBodyTextToAttachment")
            .build());
    }

    @Test
    public void getMailetInformationShouldReturnInformation() throws Exception {
        assertThat(mailet.getMailetInfo()).isEqualTo("Calendar save the bodyText as attachment");
    }
