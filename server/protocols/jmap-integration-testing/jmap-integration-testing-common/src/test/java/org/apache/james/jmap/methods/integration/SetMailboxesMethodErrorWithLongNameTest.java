...
public abstract class SetMailboxesMethodErrorWithLongNameTest {
    private static final String NAME = "[0][0]";
    private static final String ARGUMENTS = "[0][1]";
    private static final String USERS_DOMAIN = "domain.tld";
    private static int OVER_LIMIT_MAILBOX_NAME_LENGTH = 65536;
    ...
    public void setMailboxesShouldNotCreateWhenOverLimitName() {
        String overLimitName = StringUtils.repeat("a", OVER_LIMIT_MAILBOX_NAME_LENGTH);
        String requestBody =
            "[" +
                "  [ \"setMailboxes\"," +
                "    {" +
