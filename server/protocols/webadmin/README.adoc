...
Response codes :
 ...
 == Administrating domain mapping

 === Creating a domain mapping

 .bash
 ====
 curl -XPUT http://ip:port/domain_mappings
 ====
 ...
 .json
 ====
 { "realDomain": "email.com", "aliases": ["linagora.com"] }
 ====

 Response codes :
  - 200 : The domain mapping success on creating
 ...
 .bash
 ====
 curl -XGET http://ip:port/domain_mappings
 ====
 ...
 Response codes :
  - 200 : The domain mappings list was successfully retrieved
  - 404 : The user name does not exist
  - 500 : Internal error
